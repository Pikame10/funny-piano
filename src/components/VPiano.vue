        ...
        <div>
            <svg class="piano" width="691" height="448" viewBox="0 0 691 448" fill="none"
                ...
                <g filter="url(#filter0_d)">
                    ...
                    <path touche d="M92 85C92 82.2386 94.2386 80 97 80H161V332H97C94.2386 332 92 329.761 92 327V85Z"
                        fill="white" @click.prevent="playSound('/assets/sounds/C.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <rect touche x="165" y="80" width="69" height="252" fill="white"
                        @click.prevent="playSound('/assets/sounds/D.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <rect x="238" y="80" width="69" height="252" fill="white"
                        @click.prevent="playSound('/assets/sounds/E.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <rect x="311" y="80" width="69" height="252" fill="white"
                        @click.prevent="playSound('/assets/sounds/F.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <rect x="384" y="80" width="69" height="252" fill="white"
                        @click.prevent="playSound('/assets/sounds/G.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <rect x="457" y="80" width="69" height="252" fill="white"
                        @click.prevent="playSound('/assets/sounds/A.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <path touche
                        d="M530 80H594C596.761 80 599 82.2386 599 85V327C599 329.761 596.761 332 594 332H530V80Z"
                        fill="white" @click.prevent="playSound('/assets/sounds/B.mp3')" id="touche_Blanche"
                        @click.exact="changeFillColorYellow" @mouseout="resetFillColorWhite" @click="getGifs()" />

                    <path touche
                        d="M148 80H178V259C178 261.761 175.761 264 173 264H153C150.239 264 148 261.761 148 259V80Z"
                        fill="black" @click.prevent="playSound('/assets/sounds/C%23.mp3')"
                        @click.exact="changeFillColorPink" @mouseout="resetFillColorBlack" @click="getGifs()" />

                    <path touche
                        d="M221 80H251V259C251 261.761 248.761 264 246 264H226C223.239 264 221 261.761 221 259V80Z"
                        fill="black" @click.prevent="playSound('/assets/sounds/D%23.mp3')"
                        @click.exact="changeFillColorPink" @mouseout="resetFillColorBlack" @click="getGifs()" />

                    <path touche
                        d="M367 80H397V259C397 261.761 394.761 264 392 264H372C369.239 264 367 261.761 367 259V80Z"
                        fill="black" @click.prevent="playSound('/assets/sounds/F%23.mp3')"
                        @click.exact="changeFillColorPink" @mouseout="resetFillColorBlack" @click="getGifs()" />

                    <path touche
                        d="M440 80H470V259C470 261.761 467.761 264 465 264H445C442.239 264 440 261.761 440 259V80Z"
                        fill="black" @click.prevent="playSound('/assets/sounds/G%23.mp3')"
                        @click.exact="changeFillColorPink" @mouseout="resetFillColorBlack" @click="getGifs()" />

                    <path touche
                        d="M513 80H543V259C543 261.761 540.761 264 538 264H518C515.239 264 513 261.761 513 259V80Z"
                        fill="black" @click.prevent="playSound('/assets/sounds/A%23.mp3')"
                        @click.exact="changeFillColorPink" @mouseout="resetFillColorBlack" @click="getGifs()" />
                </g>
                <defs>
                    <filter id="filter0_d" x="0" y="0" width="691" height="502.24" filterUnits="userSpaceOnUse"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeFillColorYellow(e) {
                e.target.style.fill = "#FFD12D"
            },
            resetFillColorWhite(e) {
                e.target.style.fill = "white"
            },
            changeFillColorPink(e) {
                e.target.style.fill = "#E6016F"
            },
            resetFillColorBlack(e) {
